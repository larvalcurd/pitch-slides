import { createMinimalImage } from '../../entities/object';
import { createMinimalText } from '../../entities/object';
import { moveObject, resizeObject, setObjectZIndex } from '../../entities/object';
import { updateTextContent } from '../../entities/object';
...
export const handleUpdateText = () => {
  ...
  console.log('Updated text object:', {
    before: obj,
    after: updated,
  });
  return {
