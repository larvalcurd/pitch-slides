...
// import { deepCloneNestedBase, cloneCrop, mergePartialFiltersSafe } from '../factory/helpers.ts';
//
// /**
...
//  */
// function withClonedNested<T extends ImageObject>(obj: T, changes: Partial<T>): T {
